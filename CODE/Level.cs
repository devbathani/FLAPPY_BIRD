...
public class Level : MonoBehaviour {
    ...
    private const float PIPE_MOVE_SPEED = 35f;
    private const float PIPE_DESTROY_X_POSITION = -154f;
    private const float PIPE_SPAWN_X_POSITION = +154f;
    private const float GROUND_DESTROY_X_POSITION = -312f;
    ...
    private void SpawnInitialGround()
    {
        ...
        float groundY = -44.05f;
        float groundWidth = 312.9f;
    ...
    private void HandlePipeSpawning() {
        ...
        if (pipeSpawnTimer < 0) {
            ...
            float minHeight = gapSize * .45f + heightEdgeLimit;
